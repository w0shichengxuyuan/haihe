 ...
 * @date Sat Jun 10 2023 15:30 +0800
 * @version 0.00.001
 *
...
state_e e_std_swap_endian_littel16(u16 *u16_p_data)
{
    if (NULL == u16_p_data)
        return (FAILURE);
    ...
    *u16_p_data = (u16)(u_data16.s_byte.u8_byte1 << 8) |
    ...
    return (SUCCESS);
} /* e_std_swap_endian_littel16 */

state_e e_std_swap_endian_littel32(u32 *u32_p_data)
{
    if (NULL == u32_p_data)
        return (FAILURE);
