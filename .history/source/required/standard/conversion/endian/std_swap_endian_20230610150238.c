 ...
 * @date Sat Jun 10 2023 15:02 +0800
 * @version 0.00.001
 *
...
state_e e_std_swap_endian_big(std_swap_endian_data_type_e e_type, void *v_p_date)
{
    if (NULL == v_p_date)
        return (FAILURE);
