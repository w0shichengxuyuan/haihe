 ...
 * @date Sat Jun 10 2023 15:27 +0800
 * @version 0.00.001
 *
...
state_e e_std_swap_endian_big64(u64 *u64_p_data)
{
    ...
    *u64_p_data = (u64)(u_data64.s_byte.u8_byte0 << 24) |
                  (u64)(u_data64.s_byte.u8_byte1 << 16) |
                  (u64)(u_data64.s_byte.u8_byte2 <<  8) |
                  (u64)(u_data64.s_byte.u8_byte3      );
