 ...
 * @date Sat Jun 10 2023 14:45 +0800
 * @version 0.00.001
 *
...
state_e e_std_swap_endian_big(std_swap_endian_data_type_e e_type, void *v_p_buffer)
{
    if (NULL == v_p_buffer)
        return (FAILURE);
    ...
    switch (e_type)
    {
        case E_SWAP_ENDIAN_DATA_TYPE_U16:
            data_u u_data =
            {
                .u16_data = (u16)(*v_p_buffer)
            };
            u16 u16_byte0 = u_data.byte_s.u8_byte0,
                u16_byte1 = u_data.byte_s.u8_byte1;

            *v_p_buffer = (u16)(u16_byte1 << 8 | u16_byte0);
            break;
