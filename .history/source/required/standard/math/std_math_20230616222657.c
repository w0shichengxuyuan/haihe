 ...
 * @date Fri Jun 16 2023 22:26 +0800
 * @version 0.00.001
 *
...
u32 u32_std_math_subtraction(u32 u32_subtrahend, u32 u32_minuend)
{
    ...
    if (u32_subtrahend >= u32_minuend)
        u32_difference = u32_subtrahend - u32_minuend;
 ...
 * @return [0x00000000, 0xffffffff]
 */
u32 u32_std_math_multiplication(u32 u32_multiplier, u32 u32_multiplicand)
{
    u32 u32_product = 0;

    if ((M_STD_U32_MAX_VALUE / u32_multiplicand) >= u32_multiplier)
        u32_product = u32_multiplier * u32_multiplicand;

    return (u32_product);
} /* u32_std_math_multiplication */

u32 u32_std_math_division(u32 u32_divisor, u32 u32_dividend)
{
    u32 u32_quotient = 0;
