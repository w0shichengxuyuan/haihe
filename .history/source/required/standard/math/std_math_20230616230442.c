 ...
 * @date Fri Jun 16 2023 23:04 +0800
 * @version 0.00.001
 *
...
u32 u32_std_math_addition(u32 u32_augend, u32 u32_addend)
{
    ...
    else if (u32_std_math_subtraction(M_STD_U32_MAX_VALUE, u32_addend) >= u32_augend)
    {
...
u32 u32_std_math_multiplication(u32 u32_multiplicand, u32 u32_multiplier)
{
    ...
    else if (u32_std_math_division_quotient(M_STD_U32_MAX_VALUE, u32_multiplier) >= u32_multiplicand)
    {
