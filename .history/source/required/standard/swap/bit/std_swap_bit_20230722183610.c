 ...
 * @date Sat Jul 22 2023 18:36 +0800
 * @version 0.00.001
 *
 ...
 * @param[in] v_data - 数据
 * @param[in] u8_bit - 操作位
 * @return E_STD_SWAP_BIT_VALUE_ZERO
 *         E_STD_SWAP_BIT_VALUE_ONE
 */
std_swap_bit_value_e b_std_swap_bit_get(void v_data, u8 u8_bit)
{
    if (M_MAX_BIT_NUMBER < u8_bit)
