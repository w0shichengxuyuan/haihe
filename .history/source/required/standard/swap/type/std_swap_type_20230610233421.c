 ...
 * @date Sat Jun 10 2023 23:34 +0800
 * @version 0.00.001
 *
...
state_e e_std_swap_type_u64_to_u8(const u32 *u32_p_in, u8  u8_in_len,
                                        u8  *u8_p_out, u8 *u8_p_out_len)
{
    return (SUCCESS);
} /* e_std_swap_type_u32_to_u8 */

state_e e_std_swap_type_u64_to_u16(const u32 *u32_p_in,  u8  u8_in_len,
                                         u16 *u16_p_out, u8 *u8_p_out_len)
{
    return (SUCCESS);
} /* e_std_swap_type_u32_to_u16 */

state_e e_std_swap_type_u64_to_u32(const u32 *u32_p_in,  u8  u8_in_len,
                                         u64 *u64_p_out, u8 *u8_p_out_len)
{
    return (SUCCESS);
} /* e_std_swap_type_u32_to_u64 */
