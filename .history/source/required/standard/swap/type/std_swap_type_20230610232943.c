 ...
 * @date Sat Jun 10 2023 23:29 +0800
 * @version 0.00.001
 *
...
state_e e_std_swap_type_u16_to_u32(u16 *u16_p_in, u8  u8_in_len,
                                  u8  *u8_p_out, u8 *u8_p_out_len)
{
    return (SUCCESS);
} /* e_std_swap_type_u16_to_u32 */

state_e e_std_swap_type_u16_to_u64(u16 *u16_p_in, u8  u8_in_len,
                                  u8  *u8_p_out, u8 *u8_p_out_len)
{
    return (SUCCESS);
